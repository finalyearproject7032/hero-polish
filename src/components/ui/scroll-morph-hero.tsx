  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-x-0 top-[18%] z-10 flex flex-col items-center text-center px-6"
      >
        <div className="inline-flex items-center gap-2 rounded-full glass-nav px-4 py-1.5 text-xs font-medium text-primary mb-6">
          <Sparkles size={14} />
          {eyebrow}
        </div>
        <h2 className="font-display font-extrabold tracking-[-0.03em] text-[clamp(2rem,5vw,3.75rem)] leading-[1] text-foreground">
          {introTitle}
        </h2>
        <p className="mt-6 text-xs font-semibold tracking-[0.3em] text-muted-foreground">
          ↓ {introHint}
        </p>
      </motion.div>
